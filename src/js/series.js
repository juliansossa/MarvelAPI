const obtenerDatos = async () => {
    try {
        const respuesta = await fetch("https://gateway.marvel.com:443/v1/public/series?ts=1&apikey=a06e5ed27894cbe75a50b6b7c57e31ed&hash=6640616133ca308fe2d8bed822f9cd67");
...
const mostrarDatos = async (array) => {
    ...
    array.forEach(x=>{
        ...
        <div class="card">
            ...
            <p class="card__paragraph" class="card__img">${x.title}</p>
        </div>
        `
    });
